  ...
  <div id="todoListPage" class="bg-half">
    ...
    <div class="conatiner todoListPage vhContainer">
      <div class="todoList_Content">
        <div class="inputBox">
          <input type="text" placeholder="請輸入待辦事項" v-model.lazy="inputTodo" />
        ...
        <div class="todoList_list">
          <ul class="todoList_tab">
            ...
            <li>
              <a
                href="#"
                @click.prevent="changeListStatus('todo')"
                :class="listStatus === 'todo' && 'active'"
                >待完成</a
              >
            </li>
            <li>
              <a
                href="#"
                @click.prevent="changeListStatus('done')"
                :class="listStatus === 'done' && 'active'"
                >已完成</a
              >
            </li>
          </ul>
          <div class="todoList_items">
            <ul class="todoList_item" v-if="!hasNoTodo">
...
const todos = ref([
  { id: 1, content: '把冰箱發霉的檸檬拿去丟', status: STATUS.todo },
  { id: 2, content: '打電話叫媽媽匯款給我', status: STATUS.todo },
...
const hasNoTodo = computed(() => todos.value.length === 0);

const addTodo = () => {
  todos.value.push({ id: Date.now(), content: inputTodo.value, status: STATUS.todo });
  inputTodo.value = '';
};
